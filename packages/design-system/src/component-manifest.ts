...
export type DesignSystemStyleOwner = "design-system" | "design-system-preset" | "consumer";

export type DesignSystemStoryBucket = "atoms" | "molecules" | "organisms" | "templates" | null;
