...
type SidebarLayoutSplitterPrototypeProps = {
  sidebar: ReactNode;
  main: ReactNode;
  topBar?: ReactNode;
...
const SIDEBAR_STORAGE_KEY = 'sidebar-width-splitter-prototype';
const BOTTOM_STORAGE_KEY = 'bottom-panel-height-splitter-prototype';
...
export function SidebarLayoutSplitterPrototype({
  sidebar,
  main,
  topBar,
  bottomPanel,
...
}: SidebarLayoutSplitterPrototypeProps) {
  ...
  useEffect(() => {
    ...
    const updateRootWidth = () => {
      setRootWidth(rootRef.current?.clientWidth ?? window.innerWidth);
    };
  ...
  useEffect(() => {
    ...
    const updateMainColumnHeight = () => {
      setMainColumnHeight(
        mainColumnRef.current?.clientHeight ??
          (topBar ? window.innerHeight - TOP_BAR_MIN_HEIGHT : window.innerHeight),
      );
    };
...
export type { SidebarLayoutSplitterPrototypeProps };
